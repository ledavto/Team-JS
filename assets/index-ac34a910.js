import{a as x,s as v,m as w,P as b,n as h}from"./go-top-cad60ba4.js";let i=1,a="Body parts",l,y="",p="";function g(t,e=1){window.innerWidth<768?l=9:l=12,x.getFilters({filter:t,page:e,limit:l}).then(d=>{const s=document.getElementById("category-cards");s.innerHTML="",d.results.forEach(n=>{const o=document.createElement("div");o.style.background=`linear-gradient(0deg, rgba(17, 17, 17, 0.50) 0%, rgba(17, 17, 17, 0.50) 100%), url(${n.imgURL}) top / cover no-repeat`,o.classList.add("category-card"),o.innerHTML=`<h3 class="category-title">${n.name}</h3>
