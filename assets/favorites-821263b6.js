import{m,s as u,P as y}from"./go-top-c4178695.js";const l=document.querySelector(".js-favorites");document.querySelector(".js-favorites-message");const f="checkout";let v=1,a=8,g=JSON.parse(localStorage.getItem(f))??[];function p(s=1){if(g.length===0)l.insertAdjacentHTML("beforeend",`<p class="favoritesMessage js-favorites-message">
